...
def build_model(encoders):
    ...
    model.compile(loss="mse",
                  optimizer=AdamWOptimizer(learning_rate=0.01,
                                           weight_decay=0.01))
...
def build_encoders(df):
    ...
    # make
    make_enc = df['make']
    make_encoder = MinMaxScaler()
    make_encoder_attrs = ['min_', 'scale_']
    ...
    mileage_encoder = MinMaxScaler()
    mileage_encoder_attrs = ['min_', 'scale_']
    ...
    # engV
    engv_enc = df['engV']
    engv_encoder = MinMaxScaler()
    engv_encoder_attrs = ['min_', 'scale_']
    ...
    year_encoder_attrs = ['min_', 'scale_']
